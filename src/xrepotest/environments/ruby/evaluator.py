"""
Ruby-specific evaluator implementation using the BaseEvaluator framework.
"""
...
from .test_utils import create_ruby_file, is_invoke_in_code


class RubyEvaluator(BaseEvaluator):
    """Ruby-specific implementation of test evaluator."""
    ...
    def create_test_file(
        ...
        return create_ruby_file(focal_file_path, sample["function_name"], test_code)
    ...
    def run_mutation_testing(
        ...
        return run_mutation_testing(
            ...
            wrap_class=sample.get("wrap_class"),
            timeout=900,
        )
